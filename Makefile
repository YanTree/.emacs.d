...
bootstrap-borg:
	@git submodule--helper clone --name borg --path packages/borg \
	--url git@github.com:emacscollective/borg.git
	@cd packages/borg; git symbolic-ref HEAD refs/heads/main
	@cd packages/borg; git reset --hard HEAD
